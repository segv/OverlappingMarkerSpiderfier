...
2*Math.PI;c.keepSpiderfied=!1;c.markersWontHide=!1;c.markersWontMove=!1;c.nearbyDistance=20;c.circleSpiralSwitchover=9;c.circleFootSeparation=23;c.circleStartAngle=u/12;c.spiralFootSeparation=26;c.spiralLengthStart=11;c.spiralLengthFactor=4;c.spiderfiedZIndex=1E3;c.usualLegZIndex=10;c.highlightedLegZIndex=20;c.legWeight=1.5;c.legColors={usual:{},highlighted:{}};q=c.legColors.usual;p=c.legColors.highlighted;q[h.HYBRID]=q[h.SATELLITE]="#fff";p[h.HYBRID]=p[h.SATELLITE]="#f00";q[h.TERRAIN]=q[h.ROADMAP]=
"#444";p[h.TERRAIN]=p[h.ROADMAP]="#f00";c.n=function(){this.a=[];this.j=[]};c.addMarker=function(b){var d;if(null!=b._oms)return this;b._oms=!0;d=[n.addListener(b,"click",function(a){return function(d){return a.G(b,d)}}(this))];this.markersWontHide||d.push(n.addListener(b,"visible_changed",function(a){return function(){return a.o(b,!1)}}(this)));this.markersWontMove||d.push(n.addListener(b,"position_changed",function(a){return function(){return a.o(b,!0)}}(this)));this.j.push(d);this.a.push(b);return this};
c.o=function(b,d){if(null!=b._omsData&&(d||!b.getVisible())&&null==this.s&&null==this.t)return this.unspiderfy(d?b:null)};c.getMarkers=function(){return this.a.slice(0)};c.removeMarker=function(b){var d,a,g,f,e;null!=b._omsData&&this.unspiderfy();d=this.m(this.a,b);if(0>d)return this;g=this.j.splice(d,1)[0];f=0;for(e=g.length;f<e;f++)a=g[f],n.removeListener(a);delete b._oms;this.a.splice(d,1);return this};c.clearMarkers=function(){var b,d,a,g,f,e,c,l;this.unspiderfy();l=this.a;b=g=0;for(e=l.length;g<
e;b=++g){a=l[b];d=this.j[b];f=0;for(c=d.length;f<c;f++)b=d[f],n.removeListener(b);delete a._oms}this.n();return this};c.addListener=function(b,d){var a;(null!=(a=this.b)[b]?a[b]:a[b]=[]).push(d);return this};c.removeListener=function(b,d){var a;a=this.m(this.b[b],d);0>a||this.b[b].splice(a,1);return this};c.clearListeners=function(b){this.b[b]=[];return this};c.trigger=function(){var b,d,a,g,f,e;d=arguments[0];b=2<=arguments.length?x.call(arguments,1):[];d=null!=(a=this.b[d])?a:[];e=[];g=0;for(f=
